...
waggleData <- read.csv("Mechanicsburg_all_dances.csv") # Sponsler: path to our dance data
...
hiveEasting <- 278907.984269 # Sponsler: the UTM 17N (EPSG:26917) easting of the hives in meters
#hiveNorthing <- 108900				# the UK grid northing of the hives in meters
hiveNorthing <- 4430377.392885 # Sponsler: the UTM 17N (EPSG:26917) northing of the hives in meters
...
writeRaster(new.data.rast, filename = "Mechanicsburg_all_dances.tif", format = "GTiff", overwrite = T) # Sponsler: this geotiff can be loaded in QGIS to overlay on landscape layer
