...
waggleData <- read.csv("Mooreman_all_dances.csv") # Sponsler: path to our dance data
...
hiveEasting <- 295906.044842 # Sponsler: the UTM 17N (EPSG:26917) easting of the hives in meters
#hiveNorthing <- 108900				# the UK grid northing of the hives in meters
hiveNorthing <- 4406432.40089 # Sponsler: the UTM 17N (EPSG:26917) northing of the hives in meters
...
writeRaster(new.data.rast, filename = "Mooreman_all_dances.tif", format = "GTiff", overwrite = T) # Sponsler: this geotiff can be loaded in QGIS to overlay on landscape layer
